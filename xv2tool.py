...
# Wrapper for CLI or callable function
def main(file_path: str):
    """
    Main entry point for both CLI and function call.
    Preserves all checksum/encryption logic intact.
    """
    calc_checksum(file_path)
